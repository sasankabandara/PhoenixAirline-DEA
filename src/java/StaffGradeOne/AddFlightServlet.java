...
public class AddFlightServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      String dep = request.getParameter("depart");
        ...
        String eco = request.getParameter("ecoseat");
        String busi = request.getParameter("busineseat");
        String fno = request.getParameter("flightNo");

        flightAdd a = new flightAdd();
        a.adding(dep,ret,air,des,eco,busi,fno);
       response.sendRedirect("StaffOne.jsp");
